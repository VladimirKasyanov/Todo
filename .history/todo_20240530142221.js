...
const complete = document.getElementById("completed-counter")
const incomplete = document.getElementById("incomplete-counter")
const arrayLength = document.getElementById("total-counter")
...
const filterTodo = () => {
  switch (condition) {
    case 'active':
      return todoList.filter((todo) => !todo.toggleTodo);
}
}
